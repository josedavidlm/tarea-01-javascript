class Producto {
    constructor(nombreproducto, cantidad, precio,imagen) {
...
document.getElementById('Producto-form').addEventListener('submit',
    function (e) {
        // Get form values                
        ...
        console.log('imagen 004');
        

        console.log('imagen 005');
        
        
        // Instantiate a Producto
        const producto = new Producto(nombreproducto, cantidad, precio,imagen);
        ...
        if (nombreproducto === '' || cantidad === '' || precio === '') {
            ...
            // Show success alert
            //ui.showAlert('Producto Added', 'success');
